...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InputBox = __webpack_require__(169);

	var _InputBox2 = _interopRequireDefault(_InputBox);

	var _TodoItems = __webpack_require__(170);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_InputBox2.default, { createTodo: this.createTodo.bind(this) }),
	        _react2.default.createElement(_TodoItems2.default, { items: this.state.todos, deleteTodo: this.deleteTodo.bind(this),
	          toggleTodo: this.toggleTodo.bind(this) })
	      );
	    }
	  }, {
	    key: 'createTodo',
	    value: function createTodo(task) {
	    ...
	    key: 'deleteTodo',
	    value: function deleteTodo(task) {
	      var index = this.state.todos.findIndex(function (todo) {
	    ...
	    value: function toggleTodo(task) {
	      var todo = this.state.todos.find(function (todo) {
	        return todo.task === task;
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InputBox = function (_React$Component) {
	  ...
	  function InputBox() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(InputBox).apply(this, arguments));
	  }
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { type: 'text', placeholder: 'What needs to be done?',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoItems = function (_React$Component) {
	  ...
	  function TodoItems() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(TodoItems).apply(this, arguments));
	  }
	  ...
	  _createClass(TodoItems, [{
	    ...
	    value: function render() {
	      ...
	      var items = this.props.items.map(function (item, index) {
	        return _react2.default.createElement(_TodoItem2.default, _extends({ key: index
	        }, item, _this2.props));
	      });
	      return _react2.default.createElement(
	        'ul',
	    ...
	    value: function render() {
	      ...
	      if (this.props.completed) {
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement('span', { className: 'glyphicon glyphicon-remove delete', onClick: this.handleDelete.bind(this) })
	        );
	      }
	      return _react2.default.createElement(
	        'li',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _interopRequireDefault = __webpack_require__(199)['default'];
	...
	var _reactPropTypesLibElementType = __webpack_require__(201);

	var _reactPropTypesLibElementType2 = _interopRequireDefault(_reactPropTypesLibElementType);

	var _styleMaps = __webpack_require__(203);

	var _utilsBootstrapUtils = __webpack_require__(208);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$keys = __webpack_require__(204)['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(207)('keys', function($keys){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objectWithoutProperties = __webpack_require__(211)['default'];
